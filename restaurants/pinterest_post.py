...
# write your code below
    def publish_photo_msg(self, message, image_url):
        data = {
         ...
         'board':'harshsngh07/qeats-review',
         'image_url':image_url,
         'access_token':'AnyRKU2VZ2N0eeo3MUu00OhDDF2KFek69CyLN6JGdPsDbsCpGAvhwDAAAbLHRnT7dgLgwT8AAAAA'
          }
        ...
        print( response)
pinterest=Pinterest()
pinterest.publish_photo_msg("hey you","https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQLBtBU3nUOK7osT41ZsQhP4VBV7fd9euqXvXVKQH0Q7bl4txeD")
